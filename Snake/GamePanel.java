...
public class GamePanel extends JPanel implements ActionListener{
    ...
    static final int SCREEN_WIDTH = 600;     // larghezza
    static final int SCREEN_HEIGH = 600;    // altezza
    static final int UNIT_SIZE = 25;       // dimensione celle
    ...
    int appleX;
    int appleY;
    char direction = 'R';   //inizia andando a destra
    ...
    public void draw(Graphics g){
        ...
        if(running){
            ...
            // per togliere le celle togli questo for
    ...
    public void checkCollisions(){
        ...
        // controlla se la testa tocca il bordo in alto
        if(y[0] < 0){
            running = false;
        }
    ...
    public void gameOver(Graphics g){
        ...
        FontMetrics game_over = getFontMetrics(g.getFont());
        g.drawString("Game Over", 
                    (SCREEN_WIDTH - game_over.stringWidth("Game Over"))/2, 
                    (SCREEN_HEIGH/2)
        );
        ...
        g.setColor(Color.red);
            ...
            g.drawString("SCORE: " + applesEaten, 
                        (SCREEN_WIDTH - score.stringWidth("SCORE: " + applesEaten))/2, 
                        (g.getFont().getSize())
            );
